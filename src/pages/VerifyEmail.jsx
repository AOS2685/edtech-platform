...
function VerifyEmail(){
    ...
    const handleVerifyAndSignup = (e) => {
        e.preventDefault();
        // Take out the data that is present in signup page
        if(!signUpData){
            console.error("signUpData is undefined. Redirecting to signup.");
            navigate("/signup");
            return
        }
        // Destructure karna hai
        const{
                        ...
                        <div className="max-w-[500px] p-4 lg:p-8">
                            ...
                            <div className="mt-6 flex items-center justify-between">
                                     ...
                                     <button 
                                        ...
                                        // mujhe email chahiye for verification
